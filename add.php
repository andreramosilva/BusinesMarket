...
<body>
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li><a href="search.html">Consulta</a></li>
                  ...
                  <!-- Formulario -->
                    <form class="form-horizontal" action="add.php" method="post">
                      ...
                      <div class="control-group <?php echo !empty($codigoError)?'error':'';?>">
                        ...
                        <div class="controls">
                            <input class="form-control" name="codigo" type="text"  placeholder="codigo" value="<?php echo !empty($codigo)?$codigo:'';?>">
                      ...
                      <div class="control-group <?php echo !empty($tipoError)?'error':'';?>">
                        ...
                        <div class="controls">
                            <input class="form-control" name="tipo" type="text" placeholder="tipo" value="<?php echo !empty($tipo)?$tipo:'';?>">
                      ...
                      <div class="control-group <?php echo !empty($quantidadeError)?'error':'';?>">
                        ...
                        <div class="controls">
                            <input class="form-control" name="quantidade" type="text"  placeholder="quantidade" value="<?php echo !empty($quantidade)?$quantidade:'';?>">
                      ...
                      <div class="control-group <?php echo !empty($precoError)?'error':'';?>">
                        ...
                        <div class="controls">
                            <input class="form-control" name="preco" type="text"  placeholder="preco" value="<?php echo !empty($preco)?$preco:'';?>">
                      ...
                      <div class="control-group <?php echo !empty($negocioError)?'error':'';?>">
                        ...
                        <div class="controls">
                            <input class="form-control" name="negocio" type="text"  placeholder="negocio" value="<?php echo !empty($negocio)?$negocio:'';?>">
